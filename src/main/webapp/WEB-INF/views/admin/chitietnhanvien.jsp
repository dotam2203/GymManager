...
<%@ include file="/resources/include/sidebar.jsp" %>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" disabled="disabled" class="form-control" placeholder="Email" value="${info.email}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Số điện thoại" name="sdt" value="${info.sdt}">
                      </div>
                    </div>
		...
		<!-- Cập nhật lại tài khoản sau khi chỉnh sửa nhân viên -->
              ...
              <div id="myModal${info.maNV}" class="modal fade">
								<div class="modal-dialog modal-confirm">
									<div class="modal-content">
													...
													<br>		
											<center><h3 style="color: black">Bạn chắc chắn?</h3></center>	
							                <center><p style="color: black">  Bạn đang thay đổi Quyền hoặc Trạng Thái của Nhân Viên! </p></center>
										
										
										<div class="modal-footer">
										<center>
											<button id="thoat${info.maNV}" style="margin-left: 200px" type="button" class="btn btn-info" data-dismiss="modal">Đồng Ý</button>
										</center>	
										</div>
									</div>
								</div>
			...
			<script>
					function xacnhandoiquyen(){
						if(( document.getElementById("maquyen11").value.trim()=="1" || document.getElementById("trangthai").value.trim()=="0") && document.getElementById("chucvu").value.trim()=="Quản Lý" ){
  ...
  <script>
	if("${thongbao}".trim()=="1"){
		...
		demo.showNotification('top','right','Không thể thay đổi UserName!','3');
	}
	else if("${thongbao}".trim()=="4") {
		demo.showNotification('top','right','Cập nhật thông tin Tài Khoản thành công!','2');
	}
	else if("${thongbao}".trim()=="5") {
		demo.showNotification('top','right','Không thể thay đổi Quyền của chính bạn!','3');
	}
		...
		demo.showNotification('top','right','Không thể thay đổi Trạng Thái của chính bạn!','3');
	}
	...
	if("${thongbaopass}".trim()=="1") demo.showNotification('top','right','Password đã được thay đổi!','2');
