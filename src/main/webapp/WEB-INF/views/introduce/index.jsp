                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <h3>Fitness</h3>
                            <p>
                                Môn này sẽ giúp body bạn trở nên săn chắc và khỏe khoắn hơn!
                            </p>
                            <a href="">Read More</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="contact-info">
                            ...
                            <div class="contact-text">
                                <h3>Trụ Sở</h3>
                                <p>97 Man Thiện, p.Hiệp Phú, TP.Thủ Đức, TP.HCM</p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="contact-icon">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="footer-contact">
                                    ...
                                    <p><i class="fa fa-map-marker-alt"></i>97 Man Thiện, p.Hiệp Phú, TP.Thủ Đức, TP.HCM</p>
                                    <p><i class="fa fa-phone-alt"></i>+19001004</p>
                                    <p><i class="fa fa-envelope"></i>pipi@example.com</p>
