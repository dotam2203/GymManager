 ...
 function init_reload(){
    ...
    -->
			<div class="sidebar-wrapper"
				style="background-color: rgb(186, 84, 245); border-left-style: dashed;">
				<div class="logo">
					<a href="javascript:void(0)"> <img
						src="../resources/img/logo.png" alt="FITNESS">
					</a>
				</div>
				<ul class="nav">
					<li id="trangChuCheck" class="active "><a href="./home"> <i
							class="tim-icons icon-chart-pie-36"></i>
							<p>Trang Chủ</p>
					</a></li>
					<li id="lopdvCheck"><a href="./lopdv"> <i
							class="tim-icons icon-credit-card"></i>
							<p>Dịch Vụ</p>
					</a></li>
					<li><a href="./dangky"> <i class="tim-icons icon-pencil"></i>
							<p>Đăng Ký Tập</p>
					</a></li>
					<li><a href="./banghoadon"> <i
							class="tim-icons icon-notes"></i>
							<p>Hóa Đơn</p>
					</a></li>
					<li><a href="./bangusers"> <i class="tim-icons icon-badge"></i>
							<p>Khách Hàng</p>
					</a></li>
					...
					<li id="thongKeCheck"><a href="./thongke"> <i
